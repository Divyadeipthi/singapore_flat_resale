...
st.markdown("<h1 style='text-align: center; color: green;'>SINGAPORE FLAT RESALE PRICE PREDICTION</h1>",unsafe_allow_html=True)

df=pd.read_csv(r'C:\Users\user\Downloads\final (1).csv')
    ...
    if option == 'Prediction Tab':
        ...
        with col3:
            ...
            streets = {'ANG MO KIO AVE 1': 1, 'ANG MO KIO AVE 3': 2, 'ANG MO KIO AVE 4': 3, 'ANG MO KIO AVE 10': 4,
                       ...
                       'BEDOK NTH AVE 3': 24,
                       'BEDOK NTH AVE 1': 25, 'BEDOK NTH ST 1': 26, 'CHAI CHEE ST': 27, 'SIN MING RD': 28,
                       'SHUNFU RD': 29,
                       ...
                       "ST. GEORGE'S RD": 140, 'NTH BRIDGE RD': 141, 'FRENCH RD': 142, 'BEACH RD': 143,
                       'WHAMPOA DR': 144,
                       ...
                       'CRAWFORD LANE': 161, 'MARINE CRES': 162, 'MARINE DR': 163, 'MARINE TER': 164,
                       "C'WEALTH CL": 165,
                       ...
                       'LOR LEW LIAN': 180,
                       'SERANGOON NTH AVE 1': 181, 'SERANGOON AVE 2': 182, 'SERANGOON AVE 4': 183,
                       'SERANGOON CTRL': 184,
                       ...
                       'TOA PAYOH NTH': 207,
                       'POTONG PASIR AVE 3': 208, 'POTONG PASIR AVE 1': 209, 'UPP ALJUNIED LANE': 210,
                       'JOO SENG RD': 211,
                       ...
                       'TG PAGAR PLAZA': 231,
                       'KELANTAN RD': 232, 'PAYA LEBAR WAY': 233, 'UBI AVE 1': 234, 'SIMS AVE': 235,
                       'YUNG PING RD': 236,
                       ...
                       'CHIN SWEE RD': 271,
                       'SIMS PL': 272, 'HOUGANG AVE 2': 273, 'HOUGANG AVE 8': 274, 'SEMBAWANG RD': 275,
                       'SIMEI ST 1': 276,
                       'BT BATOK ST 34': 277, 'BT MERAH CTRL': 278, 'LIM LIAK ST': 279, 'JLN TENTERAM': 280,
                       'WOODLANDS ST 32': 281,
                       'SIN MING AVE': 282, 'BT BATOK ST 52': 283, 'DELTA AVE': 284, 'PIPIT RD': 285,
                       'HOUGANG AVE 4': 286,
                       'QUEENSWAY': 287, 'YISHUN ST 61': 288, 'BISHAN ST 12': 289, "JLN MA'MOR": 290,
                       'TAMPINES ST 44': 291,
                       ...
                       'HOUGANG ST 52': 340,
                       'CASHEW RD': 341, 'TOH YI DR': 342, 'HOUGANG CTRL': 343, 'KG KAYU RD': 344,
                       'TAMPINES AVE 8': 345,
                       ...
                       'HOUGANG ST 51': 367,
                       'JURONG WEST ST 72': 368, 'JURONG WEST ST 71': 369, 'PASIR RIS ST 52': 370,
                       'TAMPINES ST 32': 371,
                       'CHOA CHU KANG AVE 4': 372, 'CHOA CHU KANG LOOP': 373, 'JLN TENAGA': 374, 'TAMPINES CTRL 1': 375,
                       'TAMPINES ST 33': 376, 'BT BATOK WEST AVE 7': 377, 'JURONG WEST AVE 5': 378,
                       'TAMPINES AVE 7': 379,
                       'WOODLANDS ST 83': 380, 'CHOA CHU KANG ST 51': 381, 'PASIR RIS DR 3': 382, 'YISHUN CTRL 1': 383,
                       'CHOA CHU KANG AVE 1': 384, 'WOODLANDS ST 31': 385, 'BT MERAH LANE 1': 386,
                       'PASIR RIS ST 13': 387,
                       ...
                       'CHOA CHU KANG ST 52': 397, 'CLARENCE LANE': 398, 'CHOA CHU KANG NTH 6': 399,
                       'PASIR RIS ST 53': 400,
                       'CHOA CHU KANG NTH 5': 401, 'ANG MO KIO ST 21': 402, 'JLN DAMAI': 403,
                       'CHOA CHU KANG ST 62': 404,
                       'WOODLANDS AVE 5': 405, 'WOODLANDS DR 50': 406, 'CHOA CHU KANG ST 53': 407,
                       'TAMPINES ST 72': 408,
                       'UPP SERANGOON RD': 409, 'JURONG WEST ST 75': 410, 'STRATHMORE AVE': 411,
                       ...
                       'JURONG WEST CTRL 1': 447, 'WOODLANDS RING RD': 448, 'CHOA CHU KANG AVE 5': 449,
                       'TOH GUAN RD': 450,
                       'JURONG WEST ST 61': 451, 'WOODLANDS DR 14': 452, 'HOUGANG ST 92': 453,
                       ...
                       'BEDOK RESERVOIR VIEW': 482, 'YUNG SHENG RD': 483, 'ADMIRALTY LINK': 484,
                       ...
                       'MONTREAL DR': 494,
                       'WELLINGTON CIRCLE': 495, 'SENGKANG EAST RD': 496, 'JURONG WEST AVE 3': 497,
                       'ANCHORVALE LANE': 498,
...
with tab3:
    ...
    if st.button('Predict and Conclusion'):
        def load_data():
            # Load data
            data = pd.read_csv(r'C:\Users\user\Downloads\final (1).csv')
